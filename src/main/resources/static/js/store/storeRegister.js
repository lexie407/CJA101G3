...
const storeAddrInput  = document.getElementById('storeAddr');  // hidden
const storeImgInput   = document.getElementById('storeImg');
const previewContainer = document.querySelector('.avatar-preview');
const placeholderSpan  = previewContainer ? previewContainer.querySelector('.avatar-placeholder') : null;
...
function updateStoreAddr() {
  ...
  storeAddrInput.value = `${city}${district}${detail}`;
}
...
window.addEventListener('DOMContentLoaded', () => {
  ...
  if (initial) {
    ...
    if (matchCity) {
      ...
      populateDistricts(matchCity);
      for (const dist of taiwanData[matchCity]) {
      ...
      districtSelect.value = matchDist;
    }
